...
class Ec2Inventory(object):
    ...
    def add_instance(self, instance, region):
        ...
        if 'Service' in instance.tags.keys():
            service = instance.tags['Service'].replace('_','-')
            self.push(self.inventory, service, dest)
    ...
    def get_host_info_dict_from_instance(self, instance):
        ...
        if 'ec2_tag_Name' in instance_vars:
            instance_vars['monitoring_hostname'] = instance_vars['ec2_tag_Name']
        else:
            instance_vars['monitoring_hostname'] = self.environment + "." + instance_vars['ec2_region'] + '.' + instance.dns_name

        if 'ec2_tag_Service' in instance_vars:
            instance_vars['service'] = instance_vars['ec2_tag_Service']
